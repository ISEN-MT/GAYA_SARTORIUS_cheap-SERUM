...
_10434_DS_:
	...
	MOVLW	0x07
; removed redundant BANKSEL
	ANDWF	_analogSend_chan_1_104, W, B
	MOVWF	r0x04
	MOVLW	0x01
	MOVWF	r0x05
	MOVLW	0x00
...
;	.line	179; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	v = Value[chan];
	MOVF	_analogSend_chan_1_104, W, B
	MULLW	0x02
	MOVF	PRODH, W
	MOVWF	r0x04
	MOVFF	PRODL, r0x03
...
;	.line	212; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	if( !len ) buf[len++] = 'B';
	...
	INCF	r0x00, F
	CLRF	r0x04
	MOVLW	LOW(_analogSend_buf_1_104)
	ADDWF	r0x03, F
	MOVLW	HIGH(_analogSend_buf_1_104)
	ADDWFC	r0x04, F
	MOVFF	r0x03, FSR0L
	MOVFF	r0x04, FSR0H
	MOVLW	0x42
...
;	.line	213; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	buf[len++] = chan + 100;
	...
	MOVLW	0x64
	BANKSEL	_analogSend_chan_1_104
	ADDWF	_analogSend_chan_1_104, W, B
	MOVWF	r0x07
	MOVFF	r0x03, FSR0L
	MOVFF	r0x04, FSR0H
	MOVFF	r0x07, INDF0
...
;	.line	217; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	else printf("C A %d %d\n",chan,v);
	MOVFF	_analogSend_chan_1_104, r0x03
	MOVF	r0x06, W
	MOVWF	POSTDEC1
	MOVF	r0x05, W
	MOVWF	POSTDEC1
...
;	.line	113; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	if(ADCON0bits.GO) return chan;
	BTFSS	_ADCON0bits, 1
	BRA	_00166_DS_
	BANKSEL	_analogService_chan_1_97
	MOVF	_analogService_chan_1_97, W, B
	GOTO	_00183_DS_
_00166_DS_:
	BANKSEL	_analogService_conv_1_97
;	.line	115; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	if(conv) {
	MOVF	_analogService_conv_1_97, W, B
	BTFSC	STATUS, 2
	BRA	_00176_DS_
...
;	.line	118; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	pin = Pins[chan];
	MOVLW	LOW(_Pins)
; removed redundant BANKSEL
	ADDWF	_analogService_chan_1_97, W, B
	MOVWF	r0x02
	CLRF	r0x03
	MOVLW	HIGH(_Pins)
	ADDWFC	r0x03, F
...
_20435_DS_:
	...
	MOVLW	0x07
; removed redundant BANKSEL
	ANDWF	_analogService_chan_1_97, W, B
	MOVWF	r0x01
	MOVLW	0x01
	MOVWF	r0x03
	MOVLW	0x00
...
;	.line	159; C:/Users/sarto/Documents/Pd/externals/Fraise/analog/analog.c	conv = 1;
	MOVLW	0x01
	BANKSEL	_analogService_conv_1_97
	MOVWF	_analogService_conv_1_97, B
_00182_DS_:
	BANKSEL	_analogService_chan_1_97
